...
dotnet publish -c Release -f netcoreapp3.1 -r ubuntu.16.04-x64 $AGENT_DIR/Google.Cloud.Diagnostics.Debug/Google.Cloud.Diagnostics.Debug.csproj
cp -r $AGENT_DIR/Google.Cloud.Diagnostics.Debug/bin/Release/netcoreapp3.1/ubuntu.16.04-x64/publish/* $TEMP_AGENT_DIR
