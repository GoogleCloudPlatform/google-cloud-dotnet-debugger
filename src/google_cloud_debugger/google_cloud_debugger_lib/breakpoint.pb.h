...
#ifndef PROTOBUF_breakpoint_2eproto_INCLUDED
#define PROTOBUF_breakpoint_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::google::cloud::diagnostics::debug::Breakpoint* Arena::Create< ::google::cloud::diagnostics::debug::Breakpoint>(Arena*);
template<> ::google::cloud::diagnostics::debug::SourceLocation* Arena::Create< ::google::cloud::diagnostics::debug::SourceLocation>(Arena*);
template<> ::google::cloud::diagnostics::debug::StackFrame* Arena::Create< ::google::cloud::diagnostics::debug::StackFrame>(Arena*);
template<> ::google::cloud::diagnostics::debug::Status* Arena::Create< ::google::cloud::diagnostics::debug::Status>(Arena*);
template<> ::google::cloud::diagnostics::debug::Variable* Arena::Create< ::google::cloud::diagnostics::debug::Variable>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace cloud {
...
class Breakpoint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.diagnostics.debug.Breakpoint) */ {
 public:
  ...
  inline Breakpoint* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Breakpoint>(NULL);
  }

  Breakpoint* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Breakpoint>(arena);
  }
 ...
 private:
  ...
  friend void ::protobuf_breakpoint_2eproto::InitDefaultsBreakpointImpl();
};
// -------------------------------------------------------------------
...
class StackFrame : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.diagnostics.debug.StackFrame) */ {
 public:
  ...
  inline StackFrame* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<StackFrame>(NULL);
  }

  StackFrame* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<StackFrame>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_breakpoint_2eproto::TableStruct;
  friend void ::protobuf_breakpoint_2eproto::InitDefaultsStackFrameImpl();
};
// -------------------------------------------------------------------
...
class SourceLocation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.diagnostics.debug.SourceLocation) */ {
 public:
  ...
  inline SourceLocation* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<SourceLocation>(NULL);
  }

  SourceLocation* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<SourceLocation>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_breakpoint_2eproto::TableStruct;
  friend void ::protobuf_breakpoint_2eproto::InitDefaultsSourceLocationImpl();
};
// -------------------------------------------------------------------
...
class Variable : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.diagnostics.debug.Variable) */ {
 public:
  ...
  inline Variable* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Variable>(NULL);
  }

  Variable* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Variable>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_breakpoint_2eproto::TableStruct;
  friend void ::protobuf_breakpoint_2eproto::InitDefaultsVariableImpl();
};
// -------------------------------------------------------------------
...
class Status : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.diagnostics.debug.Status) */ {
 public:
  ...
  inline Status* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Status>(NULL);
  }

  Status* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Status>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_breakpoint_2eproto::TableStruct;
  friend void ::protobuf_breakpoint_2eproto::InitDefaultsStatusImpl();
};
// ===================================================================
...
inline ::google::cloud::diagnostics::debug::SourceLocation* Breakpoint::mutable_location() {
  ...
  if (location_ == NULL) {
    location_ = ::google::protobuf::Arena::Create< ::google::cloud::diagnostics::debug::SourceLocation >(
        GetArenaNoVirtual());
  }
...
inline ::google::protobuf::Timestamp* Breakpoint::mutable_final_time() {
  ...
  if (final_time_ == NULL) {
    final_time_ = ::google::protobuf::Arena::CreateMessage< ::google::protobuf::Timestamp >(
        GetArenaNoVirtual());
  }
...
inline ::google::cloud::diagnostics::debug::Status* Variable::mutable_status() {
  ...
  if (status_ == NULL) {
    status_ = ::google::protobuf::Arena::Create< ::google::cloud::diagnostics::debug::Status >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_breakpoint_2eproto_INCLUDED
