...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Breakpoint, logging_),
  ~0u,  // no _has_bits_
...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  ...
  { 17, -1, sizeof(StackFrame)},
  { 26, -1, sizeof(SourceLocation)},
  { 33, -1, sizeof(Variable)},
  { 43, -1, sizeof(Status)},
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Breakpoint_default_instance_.get_mutable()->final_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _Breakpoint_default_instance_.get_mutable()->status_ = const_cast< ::google::cloud::diagnostics::debug::Status*>(
...
void Breakpoint::SharedCtor() {
  id_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  condition_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  ::memset(&location_, 0, reinterpret_cast<char*>(&logging_) -
...
// @@protoc_insertion_point(message_clear_start:google.cloud.diagnostics.debug.Breakpoint)
  ...
  status_ = NULL;
  ::memset(&activated_, 0, reinterpret_cast<char*>(&logging_) -
    reinterpret_cast<char*>(&activated_) + sizeof(logging_));
}
...
void Breakpoint::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0, n = this->evaluated_expressions_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      10, this->evaluated_expressions(i), output);
  }
...
::google::protobuf::uint8* Breakpoint::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->evaluated_expressions_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        10, this->evaluated_expressions(i), deterministic, target);
  }
  ...
  if (this->has_status()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        11, *this->status_, deterministic, target);
  }
...
const ::google::cloud::diagnostics::debug::Status& Breakpoint::status() const {
  // @@protoc_insertion_point(field_get:google.cloud.diagnostics.debug.Breakpoint.status)
  return status_ != NULL ? *status_
                         : *::google::cloud::diagnostics::debug::Status::internal_default_instance();
}
::google::cloud::diagnostics::debug::Status* Breakpoint::mutable_status() {
...
::google::cloud::diagnostics::debug::Status* Breakpoint::release_status() {
...
void Breakpoint::set_allocated_status(::google::cloud::diagnostics::debug::Status* status) {
  delete status_;
  status_ = status;
  if (status) {
...
// bool logging = 12;
void Breakpoint::clear_logging() {
  logging_ = false;
}
bool Breakpoint::logging() const {
  // @@protoc_insertion_point(field_get:google.cloud.diagnostics.debug.Breakpoint.logging)
  return logging_;
}
void Breakpoint::set_logging(bool value) {
