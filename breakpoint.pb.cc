...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "proto/breakpoint.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
Breakpoint::Breakpoint()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_proto_2fbreakpoint_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* Breakpoint::descriptor() {
  protobuf_proto_2fbreakpoint_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_proto_2fbreakpoint_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
      ...
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "google.cloud.diagnostics.debug.Breakpoint.method_name"));
        } else {
          goto handle_unusual;
        }
        break;
...
::google::protobuf::Metadata Breakpoint::GetMetadata() const {
  protobuf_proto_2fbreakpoint_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_proto_2fbreakpoint_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
void Breakpoint::set_allocated_method_name(::std::string* method_name) {
  if (method_name != NULL) {
...
// repeated .google.cloud.diagnostics.debug.Variable variables = 4;
int Breakpoint::variables_size() const {
  return variables_.size();
}
void Breakpoint::clear_variables() {
  variables_.Clear();
}
const ::google::cloud::diagnostics::debug::Variable& Breakpoint::variables(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.diagnostics.debug.Breakpoint.variables)
  return variables_.Get(index);
}
::google::cloud::diagnostics::debug::Variable* Breakpoint::mutable_variables(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.diagnostics.debug.Breakpoint.variables)
  return variables_.Mutable(index);
}
::google::cloud::diagnostics::debug::Variable* Breakpoint::add_variables() {
