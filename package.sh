...
dotnet publish -c Release -f netcoreapp2.0 -r debian.8-x64 $AGENT_DIR/Google.Cloud.Diagnostics.Debug/Google.Cloud.Diagnostics.Debug.csproj
cp -r $AGENT_DIR/Google.Cloud.Diagnostics.Debug/bin/Release/netcoreapp2.0/debian.8-x64/publish/* $TEMP_AGENT_DIR
